...
class Photo extends Base{
    ...
    public  function  getPlist(Request $request){
        ...
        $album =AlbumMOdel::get(["album_name"=>$albumname,"user_id"=>$user_id]);
       $photolist= PhotoMOdel::all(["album_id"=>$album->album_id,"user_id"=>$user_id]);
    ...
    public function getAlllist(Request $request){
        $user_id = Session::get("user_id");
        $photolist= PhotoMOdel::all(["user_id"=>$user_id]);
